...
public class ProFragment extends Fragment implements OnClickListener,
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// get the layout
		mRoot = inflater.inflate(R.layout.fragment_pros, container, false);
		// init widgets
			...
			if (flag == 0) { // selecting all graph
				...
				try {
					...
					while ((strLine = br.readLine()) != null) {
						...
						measurement = measurement.substring(
								measurement.indexOf(":") + 1,
								measurement.length() - 2);
						// and save them in the graph data
						graphData = new GraphViewData(line++,
								Double.valueOf(measurement));
	 ...
	 * 
	 * @return a Boolean true if the line is for use and false if it is out of
	 *         time intervals
	 */
